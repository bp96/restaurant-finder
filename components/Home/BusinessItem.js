...
// obtains info about each business such as photo and distance from you
function BusinessItem({ business, showDir = false }) {
  ...
  // using mathematical formula to calculate distances using long/lat
  ...
  // opens directions on google maps
